...
Calculating cur_hour
Calculating clients
Calc.Time (only one expensive calculation): 0.1053
```
...
<!-- autogenlinks -->
[test_tutorial.py]: https://github.com/axiros/pycond/blob/e32a89c40a313884da5ffe1a1ccbe4b891b62af2/tests/test_tutorial.py